...
const Calendar = () => {
    ...
    let [monthData, setMonthData] = useState(new Calenda({
        month: currentMonth
    }).getStructure());
    ...
    const switchMonth = str => {
        ...
        setDay(() => {
            let {
                ...res
            } = setToToday(newMonthDataState, day && !isSetToToday ? day.dayNumber : today) ||
    ...
    return (
        <div className={styles.main}>
            <p className={`${styles.today} ${isSetToToday ? styles.isSetToToday : '' }`} onClick={defaultDay}>
